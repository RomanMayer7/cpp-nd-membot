...
ChatLogic::ChatLogic()
{
    //// Refactoring the Code to reflect  Smart Pointers implementation
    ////Creation of instance of ChatBot and assigning of handle is moved to LoadAnswerGraphFromFile() function
...
{
    //// Refactoring the Code to reflect  Smart Pointers implementation
    ////No need to mange deallocation for the nodes manually
    /*
...
void ChatLogic::LoadAnswerGraphFromFile(std::string filename)
{
        ...
        while (getline(file, lineStr))
        {
            ...
            if (type != tokens.end())
            {
                ...
                if (idToken != tokens.end())
                {
                    ...
                    if (type->second == "NODE")
                    {
                        ////Refactoring for Smart Pointers
                        ////
    ...
    //change ownership of chatbot by moving it to root node
